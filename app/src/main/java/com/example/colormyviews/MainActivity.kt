...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeColored(view: View) {
        when(view.id){
            ...
            R.id.red_button -> view.setBackgroundResource(android.R.color.holo_red_dark)
            R.id.yellow_button -> view.setBackgroundResource(android.R.color.holo_orange_dark)
